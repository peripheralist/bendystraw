...
ponder.on("RevLoans1_1:Borrow", async ({ event, context }) => {
  try {
    const {
      revnetId,
      beneficiary,
    ...
    console.error("RevLoans1_1:Borrow", e);
  }
});

ponder.on("RevLoans1_1:Liquidate", async ({ event, context }) => {
  try {
    ...
    console.error("RevLoans1_1:Liquidate", e);
  }
});

ponder.on("RevLoans1_1:RepayLoan", async ({ event, context }) => {
  try {
    const {
      loanId,
      loan: _loan,
    ...
    console.error("RevLoans1_1:RepayLoan", e);
  }
});

ponder.on("RevLoans1_1:SetTokenUriResolver", async ({ event, context }) => {
  try {
    ...
    console.error("RevLoans1_1:SetTokenUriResolver", e);
  }
});

ponder.on("RevLoans1_1:ReallocateCollateral", async ({ event, context }) => {
  try {
    const {
      loanId,
      revnetId,
    ...
    console.error("RevLoans1_1:ReallocateCollateral", e);
  }
});

ponder.on("RevLoans1_1:Transfer", async ({ event, context }) => {
  try {
    ...
    console.error("RevLoans1_1:Transfer", e);
  }
});
